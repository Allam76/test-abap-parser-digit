...
class zcl_sql_tree_node definition public
    create public.
  public section.
    types tree_node_list_tab type table of ref to zcl_sql_tree_node with empty key.
    types: begin of label_hash_entry,
        key type string,
        value type ref to zcl_sql_tree_node,
    ...
    methods get importing key type string returning value(result) type ref to zcl_sql_tree_node.
endclass.

class zcl_sql_tree_node implementation.
  method constructor.
    me->text = text.
    me->offset = offset.
